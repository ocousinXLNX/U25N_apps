...
proc create_root_design { parentCell } {
  ...
  # Create instance: lineArb_0, and set properties
  set lineArb_0 [ create_bd_cell -type ip -vlnv Xilinx:Fintech:lineArb:1.2 lineArb_0 ]
  ...
  connect_bd_intf_net -intf_net INTERC_from_MAC_M00_AXIS [get_bd_intf_pins INTERC_from_MAC/M00_AXIS] [get_bd_intf_pins lineArb_0/in_2]
  connect_bd_intf_net -intf_net INTERC_from_MAC_M01_AXIS [get_bd_intf_pins INTERC_from_MAC/M01_AXIS] [get_bd_intf_pins lineArb_0/in_3]
  ...
  connect_bd_intf_net -intf_net axi_interconnect_M02_AXI [get_bd_intf_pins axi_interconnect/M02_AXI] [get_bd_intf_pins lineArb_0/s_axi_CTRL]
  ...
  connect_bd_intf_net -intf_net axis_data_fifo_from_MAC0_M_AXIS [get_bd_intf_pins axis_data_fifo_from_MAC0/M_AXIS] [get_bd_intf_pins lineArb_0/in_0]
  connect_bd_intf_net -intf_net axis_data_fifo_from_MAC1_M_AXIS [get_bd_intf_pins axis_data_fifo_from_MAC1/M_AXIS] [get_bd_intf_pins lineArb_0/in_1]
  ...
  connect_bd_intf_net -intf_net lineArb_0_out_0 [get_bd_intf_pins lineArb_0/out_0] [get_bd_intf_pins slice_to_MAC2/S_AXIS]
  connect_bd_intf_net -intf_net lineArb_0_out_1 [get_bd_intf_pins lineArb_0/out_1] [get_bd_intf_pins slice_to_MAC3/S_AXIS]
  connect_bd_intf_net -intf_net lineArb_0_out_2 [get_bd_intf_pins lineArb_0/out_2] [get_bd_intf_pins slice_to_MAC0/S_AXIS]
  connect_bd_intf_net -intf_net lineArb_0_out_3 [get_bd_intf_pins lineArb_0/out_3] [get_bd_intf_pins slice_to_MAC1/S_AXIS]

  # Create port connections
  connect_bd_net -net ARESETN_1 [get_bd_pins INTERC_from_MAC/ARESETN] [get_bd_pins INTERC_from_MAC/M00_AXIS_ARESETN] [get_bd_pins INTERC_from_MAC/M01_AXIS_ARESETN] [get_bd_pins INTERC_from_MAC/S00_AXIS_ARESETN] [get_bd_pins Register_interface/s00_axi_aresetn] [get_bd_pins axi_interconnect/M02_ARESETN] [get_bd_pins axis_data_fifo_from_Internal/s_axis_aresetn] [get_bd_pins axis_data_fifo_from_MAC0/s_axis_aresetn] [get_bd_pins axis_data_fifo_from_MAC1/s_axis_aresetn] [get_bd_pins lineArb_0/ap_rst_n] [get_bd_pins reset_latch_dyn_0/rstn_200M] [get_bd_pins slice_to_MAC0/aresetn] [get_bd_pins slice_to_MAC1/aresetn] [get_bd_pins slice_to_MAC2/aresetn] [get_bd_pins slice_to_MAC3/aresetn]
  ...
  connect_bd_net -net clk_200M_in_1 [get_bd_ports clk_200M_in] [get_bd_pins INTERC_from_MAC/ACLK] [get_bd_pins INTERC_from_MAC/M00_AXIS_ACLK] [get_bd_pins INTERC_from_MAC/M01_AXIS_ACLK] [get_bd_pins INTERC_from_MAC/S00_AXIS_ACLK] [get_bd_pins axi_interconnect/M02_ACLK] [get_bd_pins axis_data_fifo_from_Internal/s_axis_aclk] [get_bd_pins axis_data_fifo_from_MAC0/s_axis_aclk] [get_bd_pins axis_data_fifo_from_MAC1/s_axis_aclk] [get_bd_pins lineArb_0/ap_clk] [get_bd_pins reset_latch_dyn_0/clk_200M_in] [get_bd_pins slice_to_MAC0/aclk] [get_bd_pins slice_to_MAC1/aclk] [get_bd_pins slice_to_MAC2/aclk] [get_bd_pins slice_to_MAC3/aclk]
  ...
  assign_bd_address -offset 0x800E0000 -range 0x00010000 -target_address_space [get_bd_addr_spaces S_AXI_Lite] [get_bd_addr_segs lineArb_0/s_axi_CTRL/Reg] -force
