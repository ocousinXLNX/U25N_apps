...
proc create_root_design { parentCell } {
  ...
  # Create instance: sdnet_0, and set properties
  set sdnet_0 [ create_bd_cell -type ip -vlnv xilinx.com:ip:sdnet:2.2 sdnet_0 ]
  set_property -dict [ list \
   CONFIG.AXIS_CLK_FREQ_MHZ {200.0} \
   CONFIG.CAM_TABLE_PARAMS {} \
   CONFIG.DIRECT_TABLE_PARAMS {} \
   CONFIG.JSON_TIMESTAMP {1632994590} \
   CONFIG.M_AXI_HBM_ADDR_WIDTH {33} \
   CONFIG.M_AXI_HBM_DATA_WIDTH {256} \
   CONFIG.M_AXI_HBM_ID_WIDTH {6} \
   CONFIG.M_AXI_HBM_PROTOCOL {0} \
   CONFIG.P4_FILE {/scratch/kestera/projects/DFX/U25N_DFX/dynamic/p4_example/p4_example.srcs/sources_1/echo.p4} \
   CONFIG.PKT_RATE {200.0} \
   CONFIG.S_AXI_ADDR_WIDTH {1} \
   CONFIG.USER_EXTERNS {} \
   CONFIG.USER_METADATA_ENABLES {metadata.echo_port {input true output true}} \
   CONFIG.USER_META_DATA_WIDTH {16} \
   CONFIG.USER_META_FORMAT {metadata.echo_port {length 16 start 0 end 15}} \
 ] $sdnet_0
  ...
  connect_bd_intf_net -intf_net axi_interconnect_M02_AXI [get_bd_intf_pins axi_interconnect/M02_AXI] [get_bd_intf_pins sdnet_0/s_axi]
  connect_bd_intf_net -intf_net axi_interconnect_M03_AXI [get_bd_intf_pins axi_gpio_0/S_AXI] [get_bd_intf_pins axi_interconnect/M03_AXI]
  ...
  connect_bd_intf_net -intf_net axis_data_fifo_from_MAC0_M_AXIS [get_bd_intf_pins axis_data_fifo_from_MAC0/M_AXIS] [get_bd_intf_pins sdnet_0/s_axis]
  ...
  connect_bd_net -net clk_100M_in_1 [get_bd_ports clk_100M_in] [get_bd_pins Register_interface/s00_axi_aclk] [get_bd_pins axi_gpio_0/s_axi_aclk] [get_bd_pins axi_interconnect/ACLK] [get_bd_pins axi_interconnect/M00_ACLK] [get_bd_pins axi_interconnect/M01_ACLK] [get_bd_pins axi_interconnect/M02_ACLK] [get_bd_pins axi_interconnect/M03_ACLK] [get_bd_pins axi_interconnect/S00_ACLK] [get_bd_pins reset_latch_dyn_0/clk_100M_in] [get_bd_pins sdnet_0/s_axi_aclk] [get_bd_pins version_register_0/s00_axi_aclk]
  connect_bd_net -net clk_200M_in_1 [get_bd_ports clk_200M_in] [get_bd_pins INTERC_from_MAC/ACLK] [get_bd_pins INTERC_from_MAC/M00_AXIS_ACLK] [get_bd_pins INTERC_from_MAC/M01_AXIS_ACLK] [get_bd_pins INTERC_from_MAC/S00_AXIS_ACLK] [get_bd_pins axis_data_fifo_from_Internal/s_axis_aclk] [get_bd_pins axis_data_fifo_from_MAC0/s_axis_aclk] [get_bd_pins axis_data_fifo_from_MAC1/s_axis_aclk] [get_bd_pins reset_latch_dyn_0/clk_200M_in] [get_bd_pins sdnet_0/s_axis_aclk] [get_bd_pins slice_to_MAC0/aclk] [get_bd_pins slice_to_MAC1/aclk] [get_bd_pins slice_to_MAC2/aclk] [get_bd_pins slice_to_MAC3/aclk]
  ...
  connect_bd_net -net reset_latch_dyn_0_rstn_100M1 [get_bd_pins axi_gpio_0/s_axi_aresetn] [get_bd_pins axi_interconnect/ARESETN] [get_bd_pins axi_interconnect/M00_ARESETN] [get_bd_pins axi_interconnect/M01_ARESETN] [get_bd_pins axi_interconnect/M02_ARESETN] [get_bd_pins axi_interconnect/M03_ARESETN] [get_bd_pins axi_interconnect/S00_ARESETN] [get_bd_pins reset_latch_dyn_0/rstn_100M] [get_bd_pins sdnet_0/s_axi_aresetn] [get_bd_pins version_register_0/s00_axi_aresetn]
  connect_bd_net -net resetn_1 [get_bd_ports resetn] [get_bd_pins reset_latch_dyn_0/resetn_in]
  connect_bd_net -net xlslice_0_Dout [get_bd_pins sdnet_0/user_metadata_in] [get_bd_pins xlslice_0/Dout]
  connect_bd_net -net xlslice_1_Dout [get_bd_pins sdnet_0/user_metadata_in_valid] [get_bd_pins xlslice_1/Dout]
